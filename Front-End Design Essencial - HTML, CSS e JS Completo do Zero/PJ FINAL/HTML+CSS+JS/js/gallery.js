...
var frameContainer = document.querySelector('.pj-gallery-frame-container');
var frameImage = document.querySelector('.pj-gallery-frame-image');
var galleryImages = document.querySelectorAll('.pj-thumb-box');
var closeGallery = document.querySelectorAll('.pj-toggle-gallery');
var btnNext = document.querySelector('.pj-item-next');
var btnPrev = document.querySelector('.pj-item-prev');
var currCounter = document.querySelector('.pj-current-slide');
var totalCounter = document.querySelector('.pj-total-slide');
var skeletonLoading = document.querySelector('.pj-skeleton-loading');

var postGallery = document.querySelector('.pj-post-gallery');
...
const skeletonAnim = function (imagem) {
    ...
    myImage.addEventListener('load', function () {
        skeletonLoading.classList.add('pj-fade-out');
...
const getImageSrc = function () {
    for (var i = 0; i < galleryImages.length; i++) {
        galleryImages[i].addEventListener('click', function () {
            ...
            overlay.classList.add('pj-is-open');
            frameContainer.classList.add('pj-is-open');
...
for (var c = 0; c < closeGallery.length; c++) {
    closeGallery[c].addEventListener('click', function () {
        overlay.classList.remove('pj-is-open');
        frameContainer.classList.remove('pj-is-open');
    });
}
