...
var sliderItem = document.querySelectorAll(".pj-slider-item");
...
var setActiveSlide = function () {
  for (var sld = 0; sld < sliderItem.length; sld++) {
    ...
    if (mySlideNum === currentCounter) {
      ...
      sliderItem[sld]
        .querySelector(".pj-portfolio-item-box")
        .classList.add("pj-scale-right");
      sliderItem[sld]
        .querySelector(".pj-portfolio-item-thumb img")
        .classList.add("pj-scale-up");
      sliderItem[sld]
        .querySelector(".pj-portfolio-item-info")
        .classList.add("pj-fade-from-left");
    }
  }
};
...
var changeActive = function () {
  ...
  for (var rms = 0; rms < sliderItem.length; rms++) {
    ...
    sliderItem[rms]
      .querySelector(".pj-portfolio-item-box")
      .classList.remove("pj-scale-right");
    sliderItem[rms]
      .querySelector(".pj-portfolio-item-thumb img")
      .classList.remove("pj-scale-up");
    sliderItem[rms]
      .querySelector(".pj-portfolio-item-info")
      .classList.remove("pj-fade-from-left");
  }
  setActiveNav();
  setActiveSlide();
};
